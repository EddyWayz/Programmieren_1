...
public class Methoden{
  ...
  // Diese Methode bekommt einen int n, potenziert diese mit 3 und gibt die Zahl als long aus.
  // Datentyp long, weil die Zahlen sehr groß werden können.
  static long calculateCubicNumber(int n){
    return n*n*n;
  }
  // Diese Methode bekommt einen int n und addiert die Cubikzahlen von 1 bis n. Diese Summe wird dann als long ausgegeben.
  // Datentyp long, weil die Zahlen sehr groß werden können.
  ...
  // Diese Methode bekommt einen integer n und gibt das Quadrat der Summe von 1 bis n als long aus.
  // Datentyp long, weil die Zahlen sehr groß werden können.
  ...
  // Datentyp kann hier int sein, da eine Quersumme, die größer als die in Integer verfügbaren Zahlen, 
