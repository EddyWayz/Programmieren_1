...
public class Date {
    ...
    /**
     * Copy constructor that creates a new Aufgabenblatt_7.Date object with the same values as another Aufgabenblatt_7.Date object.
     *
     * @param other The Aufgabenblatt_7.Date object to copy.
     */
    ...
    /**
     * Checks if this date is before another date without  taking the year into account.
     *
     * @param other The date to compare with.
     * @return true if this date is before the other date, false otherwise.
     */
    public boolean isBeforeWithoutYear(Date other) {
        if (this.month < other.month) {
            return true;
        } else if (this.month > other.month) {
            return false;
    ...
    /**
     * Returns a new Aufgabenblatt_7.Date object representing the next day.
     *
     * @return The next day's Aufgabenblatt_7.Date object.
     */
    public Date nextDay() {
